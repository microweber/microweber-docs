<?php  
header("Location: developer-guide/index");
exit;
 ?>

<div class="home">
  <h1>Welcome to &nbsp;<span class="mwlogo"></span></h1>
  <br>
  ...
  <hr>
  <a href="functions/_nav/index" class="btn btn-primary btn-large">Get Started with Microweber API</a> </div>
